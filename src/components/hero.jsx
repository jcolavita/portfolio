  ...
  return (
    <div className="md:mx-16 mx-8 md:flex  font-sora ">
      <div className="  md:w-1/2  pt-14 flex flex-col ">
        ...
        <button className="md:w-64 w-full py-[6px] mt-10 bg-white rounded-full text-black md:hover:scale-110 transition ease-in-out delay-75 hover:-translate-y-1 duration-300">
          Contactanos
        </button>
      </div>
